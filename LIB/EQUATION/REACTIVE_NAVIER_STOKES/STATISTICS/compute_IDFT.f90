...
! ---------------------------------------------------------------------------
! sort of a HACK
! use this extra subroutine for full IDFT, to exchange this subroutine someday
! ---------------------------------------------------------------------------
subroutine compute_IDFT_full( params_physics, phi_hat, phi, x0, dx )
...
! main body
    ...
    ! return real valued velocity field
    phi = real(dummy(1:Bs(1),1:Bs(2),1:Bs(3)), kind=rk)

end subroutine compute_IDFT_full
