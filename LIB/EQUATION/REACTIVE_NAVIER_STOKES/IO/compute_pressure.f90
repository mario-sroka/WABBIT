...
! WABBIT
! ============================================================================================
!> \name compute_pressure.f90
!> \version 0.5
!> \author msr
!
!> \brief compute pressure with cantera function 
!>
...
subroutine compute_pressure( params_physics, phi, phi_work, gas )
